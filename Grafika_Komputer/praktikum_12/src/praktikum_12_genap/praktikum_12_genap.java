package praktikum_12_genap;

import java.awt.*;
import java.awt.event.*;

public class praktikum_12_genap extends Frame implements Runnable {
    ...
    public static void main(String[] args) {
        praktikum_12_genap app = new praktikum_12_genap(); // membuat objek baru modul_12

    }

    public praktikum_12_genap() {
