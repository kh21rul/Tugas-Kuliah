package praktikum12_ganjil;
import java.awt.*;
import java.awt.event.*;

public class praktikum12ganjil extends Frame implements Runnable {
    ...
    public static void main(String[] args) {
        praktikum12ganjil app = new praktikum12ganjil(); // membuat objek baru modul_12

    }

    public praktikum12ganjil() {
