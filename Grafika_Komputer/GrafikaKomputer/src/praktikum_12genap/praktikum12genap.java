package praktikum_12genap;

import java.awt.*;
import java.awt.event.*;

public class praktikum12genap extends Frame implements Runnable {
    ...
    public static void main(String[] args) {
        praktikum12genap app = new praktikum12genap(); // membuat objek baru modul_12

    }

    public praktikum12genap() {
